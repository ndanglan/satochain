...
type DropdownSubTriggerVariantProps = VariantProps<
  typeof dropdownSubTriggerVariants
>;
...
export type DropdownPortalProps = React.ComponentPropsWithoutRef<
  typeof DropdownPrimitive.Portal
>;
